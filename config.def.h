...
static const char *dmenudesktopcmd[] = { "j4-dmenu-desktop", "--term=st", NULL };
...
static const char *filemgrxcwdcmd[] = { "/bin/sh", "-c", "exec st -e lf \"$(xcwd)\"", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|Mod1Mask,              XK_t,      spawn,          {.v = termxcwdcmd } },
	{ MODKEY,                       XK_w,      spawn,          {.v = browsercmd } },
	{ MODKEY|Mod1Mask,              XK_w,      spawn,          {.v = privatebrowsercmd } },
	{ MODKEY,                       XK_f,      spawn,          {.v = filemgrcmd } },
	{ MODKEY|Mod1Mask,              XK_f,      spawn,          {.v = filemgrxcwdcmd } },
